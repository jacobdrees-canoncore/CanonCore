...
([[0191-removing-a-worktree-drops-its-databases-and-refuses-a-list-naming-canoncore]]), and this sweep
...
| Databases on disk | nothing | the volume | `db:drop-worktree` at each removal (ADR-0191), then this sweep, so what stands is the live worktrees' own |

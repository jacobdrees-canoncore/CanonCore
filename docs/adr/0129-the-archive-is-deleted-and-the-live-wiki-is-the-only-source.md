...
Every figure the seven affected records took from the archive was re-derived from the live wiki on
2026-09-13 by `provider-wiki`'s `pnpm measure:live`, which replaced the five scripts that opened
the deleted DuckDB. ADR-0016, 0030, 0057, 0060, 0070, 0073 and 0077 each carry their own
re-measured figures and the date.

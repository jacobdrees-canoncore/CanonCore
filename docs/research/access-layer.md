...
both still say this**, the Service-Specific Terms last updated 2026-06-02 and the docs page 2026-08-25.
That ticket also found this section answers a question it had been filed as unconsidered ground: a
proxy in front of a rented slot is the same clause as a tunnel out of a home machine. **It is moot for
the slot**, which reaches the owner's domain through the vendor's own front end with no Cloudflare on
the path at all — ADR-0109 carries that.

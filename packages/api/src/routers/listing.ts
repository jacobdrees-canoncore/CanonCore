...
/**
 * HOW MANY ENTRIES ONE ANSWER CARRIES, when the caller does not say.
 *
 ...
 *
 * AND THE OTHER HALF IS `after`, which is what REACHES the entries past this
 ...
 * whether it named anything. One that names no entry names no position either,
 * so the walk starts at the beginning rather than raising -- and a reader whose
 * bookmark outlived the entry it was cut at gets the listing rather than an
 * error page.
 *
 * WRITTEN ONCE FOR EVERY LISTING, entries of items and entries of placements

...
describe("a figure this tree states about itself", () => {
  ...
  it("counts the hand-built redirects ADR-0109's rule governs, per file", () => {
    ...
    // FOUR SINCE CNCORE-326, three since CNCORE-262, and it was one.
    ...
    // branches with no fall-through redirected NOWHERE. The rule this figure
    ...
    expect(handBuiltRedirectsIn("apps/web/src/app/settings/actions.ts")).toBe(4);
  });

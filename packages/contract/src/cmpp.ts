...
export const manifest = z
  ...
  /**
   * LISTING CONTAINERS OBLIGES BROWSING THEM, and it is the only rule the
   * operations list carries beyond the required two.
   *
   ...
   * declaration is a promise, and a promise of ids this provider will not serve
   * is not a capability the app could honour by being careful.
   */
  .refine(
    (declared) =>
